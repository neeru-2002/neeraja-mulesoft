...
class DBOperations{
    ...
    public int createTable(Connection con) throws SQLException{
        String qr="create table movies(moviename varchar(50),actor varchar(50),actress varchar(50),YOR varchar(4),director varchar(50))";
    ...
    public void insert(Connection con,Scanner sc) throws SQLException{
        ...
        String moviename,actor,actress,yearofrelease,dirname;
        sc.nextLine();
        ...
        stmt.setString(4, yearofrelease);
